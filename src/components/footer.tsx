...
export default function Footer() {
  ...
  return (
    <div className="bg-gradient-to-t from-[#0C4532] to-[#327886] to-100% container-fluid mx-auto px-10 sm:px-20 p-10 ">
       <div className="flex gap-20 sm:gap-40 mt-20 mb-12">
        <div>
