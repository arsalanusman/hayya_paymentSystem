          ...
          <div className="px-0 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6">
            <div className="grid gap-2 items-baseline grid-cols-1">
              <div className="ease-in duration-300">
                ...
                <>
                {status == 'Paid' ?  
                  <svg className="center  md:w-[666px] sm:w-screen mb-[-200px]" width="666" height="666" viewBox="0 0 666 666" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M323 332C323 326.429 327.429 322 333 322C338.571 322 343 326.429 343 332C343 337.571 338.571 342 333 342C327.429 342 323 337.571 323 332ZM337.489 327.15C337.987 327.449 338.149 328.096 337.85 328.594L333.113 336.489C332.946 336.767 332.661 336.953 332.339 336.992C332.017 337.032 331.695 336.921 331.466 336.692L328.308 333.534C327.897 333.123 327.897 332.456 328.308 332.045C328.719 331.634 329.386 331.634 329.797 332.045L332.001 334.25L336.045 327.511C336.344 327.013 336.99 326.851 337.489 327.15Z" fill="#FAF3DD"/>
                  </svg>
