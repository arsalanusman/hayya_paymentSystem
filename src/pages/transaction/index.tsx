          ...
          <div className="px-0 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6">
            <div className="grid gap-2 items-baseline grid-cols-1">
              <div className="ease-in duration-300">
                ...
                {isLoading ? (
                <>
                {status == 'Paid' ?  <svg className="center" width="666" height="400" viewBox="0 0 666 666" fill="none" xmlns="http://www.w3.org/2000/svg">
...
: <svg className="center"  width="666" height="400" viewBox="0 0 666 666" fill="none" xmlns="http://www.w3.org/2000/svg">
